...
public class Bruch {
  ...
  private int zaehler;
  private int nenner;
  BruchFormat format = new SchraegstrichFormat();
  ...
  /**
   * Setzt das Format des Bruchs.
   *
   * @param format
   *            das Format des Bruchs.
   */
  ...
  /**
   * Gibt das Format des Bruchs zurueck.
   *
   * @return das Format des Bruchs.
   */
  ...
  public String toString() {
    return format.bruchToString(this.zaehler, this.nenner);
  }
